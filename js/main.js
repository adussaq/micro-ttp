...
(function() {
	...
	const buildGroups = function (data) {
		// look for partners
		let uniqueCultures = [];
		...
		return uniqueCultures.map(function (ctxGroup) {
			...
			let organisms = ctxGroup.map(function (arr, ind1) {
				...
				return arr[6].map(function (org, ind2) {
			...
			organisms.forEach(function (orgArr) {
				...
				uniqueOrgsHash[org].testName.push(ctxGroup[orgArr[1]][0]);
				uniqueOrgsHash[org].year.push(ctxGroup[orgArr[1]][1]);
				uniqueOrgsHash[org].collectTime.push(ctxGroup[orgArr[1]][2]);
				uniqueOrgsHash[org].hoursToPositive.push(ctxGroup[orgArr[1]][3]);
				uniqueOrgsHash[org].falsePositive.push(ctxGroup[orgArr[1]][4]);
	...
	const buildPage = function(data) {
		...
		let byVisitOrg = buildGroups(data.data);
